    ...
    <div class="row">
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
          ...
          <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right" /></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-6">
      ...
      <section class="col-lg-7 connectedSortable">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <ul class="todo-list" data-widget="todo-list">
              <li>
                ...
                <!-- Emphasis label -->
                <small class="badge badge-danger"><i class="far fa-clock" /> 2 mins</small>
              ...
              <li>
                ...
                <small class="badge badge-info"><i class="far fa-clock" /> 4 hours</small>
                <div class="tools">
                  <i class="fas fa-edit" />
                  <i class="fas fa-trash-o" />
                </div>
              ...
              <li>
                ...
                <small class="badge badge-warning"><i class="far fa-clock" /> 1 day</small>
                <div class="tools">
                  <i class="fas fa-edit" />
                  <i class="fas fa-trash-o" />
                </div>
              ...
              <li>
                ...
                <span class="text">Let theme shine like a star</span>
                <small class="badge badge-success"><i class="far fa-clock" /> 3 days</small>
                <div class="tools">
                  <i class="fas fa-edit" />
                  <i class="fas fa-trash-o" />
                </div>
              ...
              <li>
                ...
                <small class="badge badge-primary"><i class="far fa-clock" /> 1 week</small>
                <div class="tools">
                  <i class="fas fa-edit" />
                  <i class="fas fa-trash-o" />
                </div>
              ...
              <li>
                ...
                <span class="text">Let theme shine like a star</span>
                <small class="badge badge-secondary"><i class="far fa-clock" /> 1 month</small>
                <div class="tools">
                  <i class="fas fa-edit" />
                  <i class="fas fa-trash-o" />
                </div>
          ...
          <div class="card-footer clearfix">
            <button type="button" class="btn btn-primary float-right"><i class="fas fa-plus" /> Add item</button>
          </div>
        </div>
        <!-- /.card -->
      </section>
